...
// // BeaconMetrics reports Beacon information about the beacon chain.
...
// func NewBeaconJob(client eth2client.Service, ap api.ConsensusClient, beac Node, log logrus.FieldLogger, namespace string, constLabels map[string]string) BeaconMetrics {
...
// 	b.beaconNode.OnFinalizedCheckpoint(ctx, b.handleFinalizedCheckpointEvent)

// 	return nil
// }

// func (b *BeaconMetrics) handleEmptySlot(ctx context.Context, event *beacon.EmptySlotEvent) error {
// 	b.EmptySlots.Inc()

// 	return nil
// }

// func (b *BeaconMetrics) handleBlockInserted(ctx context.Context, event *beacon.BlockInsertedEvent) error {
// 	// Fetch the slot
